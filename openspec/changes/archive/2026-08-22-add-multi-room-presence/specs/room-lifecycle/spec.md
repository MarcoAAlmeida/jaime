...
The system SHALL let a user, from the site's entry point, either create
a new room or join an existing one by ID or link.

#### Scenario: Landing page presents both options
- **WHEN** a user opens the site with no room already selected
